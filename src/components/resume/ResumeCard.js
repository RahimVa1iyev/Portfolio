...
const ResumeCard = ({ title, subTitle, result, des, front, back }) => {
  return (
    <div className="w-full h-1/3 group flex">
      ...
      <div className="w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300  rounded-lg p-12 lgl:px-10 flex flex-col justify-center gap-1 lgl:gap-10 shadow-shadowOne ">
        ...
        <div>
       {
        ...
        {
          front &&
          <p className="text-sm md:text-base font-medium text-gray-400 group-hover:text-gray-300 duration-300 mb-2">
            {front}
          </p>
        }
        {
